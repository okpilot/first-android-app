...
Subject to the **multi-round discipline**: stability floor **N=2** normally, **N=3** if the diff
touches `backend/migrations/**/*.sql`; ceiling 4 rounds, then escalate to the user.
