...
**RESUME =** pick the next slice: optional `search_path=''` hardening (the last #3 leftover, auth-independent), **#21** in-app empty-state hints, or the **contact activity view** (fills the master-detail whitespace).
