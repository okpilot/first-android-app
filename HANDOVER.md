...
**RESUME = phone QA via `/updatephone` → S23+: add / complete / edit / archive / restore a task against homebase.** The Slice 1–3 RPC phone QA (below) is still owed too — batch it with the Tasks phone QA.
