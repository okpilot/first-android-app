...
- **Tasks** — a lightweight to-do list: add a task, tap it to see its details (title, status,
  dates), then tap Edit to change it. Mark tasks complete or archive ones you're done with.
  Completed and archived tasks tuck into their own sections so your active list stays clean,
